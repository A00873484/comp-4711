														...
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/8072314245_43d8c62a8f_o.jpg" alt="">
																...
																<div class="package-title-wrapper">
																	...
																	<h2 class="package-title">
																		<a href="/explore">Jiro Ono's world-class sushi</a>
																	</h2>
																</div>
															</div>
													...
													<div class="four columns gdl-package-grid2">
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/15368957195_9c0bf2b586_o.jpg" alt="">
																		<div class="package-ribbon-wrapper">
																			<div class="package-type normal-type">Learn More</div>
																			<div class="clear"></div>
																			<div class="package-type-gimmick"></div>
																...
																<div class="package-title-wrapper">
																	<div class="package-title-overlay"></div>
																	<h2 class="package-title">
																		<a href="/explore">Tokyo Skyline</a>
																	</h2>
																</div>
															</div>
															<div class="package-date"> <i class="icon-time"></i>
													...
													<div class="four columns gdl-package-grid2">
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/15156251888_fdf67fe852_o.jpg" alt="">
																		<div class="package-ribbon-wrapper">
																			<div class="package-type normal-type">Learn More</div>
																			<div class="clear"></div>
																			<div class="package-type-gimmick"></div>
																...
																<div class="package-title-wrapper">
																	<div class="package-title-overlay"></div>
																	<h2 class="package-title">
																		<a href="/explore">Breaktaking top of Mt.Fuji</a>
																	</h2>
																</div>
															</div>
															<div class="package-date"> <i class="icon-time"></i>
													...
													<div class="four columns gdl-package-grid2">
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/15338797172_b072f6eeb5_o.jpg" alt="">
																		<div class="package-ribbon-wrapper">
																			<div class="package-type normal-type">Learn More</div>
																			<div class="clear"></div>
																			<div class="package-type-gimmick"></div>
																...
																<div class="package-title-wrapper">
																	<div class="package-title-overlay"></div>
																	<h2 class="package-title">
																		<a href="/explore">Embrace the wilderness</a>
																	</h2>
																</div>
															</div>
															<div class="package-date"> <i class="icon-time"></i>
													...
													<div class="four columns gdl-package-grid2">
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/15367895181_b88f912991_k.jpg" alt="">
																		<div class="package-ribbon-wrapper">
																			<div class="package-type normal-type">Learn More</div>
																			<div class="clear"></div>
																			<div class="package-type-gimmick"></div>
																...
																<div class="package-title-wrapper">
																	<div class="package-title-overlay"></div>
																	<h2 class="package-title">
																		<a href="/explore">Take part in tradition</a>
																	</h2>
																</div>
															</div>
															<div class="package-date"> <i class="icon-time"></i>
													...
													<div class="four columns gdl-package-grid2">
														<div class="package-content-wrapper">
															<div class="package-thumbnail-outer-wrapper">
																<div class="package-media-wrapper gdl-image">
																	<a href="/explore">
																		<img src="/img/15278354632_ea0408bee3_o.jpg" alt="">
																		<div class="package-ribbon-wrapper">
																			<div class="package-type normal-type">Learn More</div>
																			<div class="clear"></div>
																			<div class="package-type-gimmick"></div>
																...
																<div class="package-title-wrapper">
																	<div class="package-title-overlay"></div>
																	<h2 class="package-title">
																		<a href="/explore">Marvel at ancient art</a>
																	</h2>
																</div>
															</div>
															<div class="package-date"> <i class="icon-time"></i>
				...
				<div class="container footer-container">
					<div class="footer-widget-wrapper">
						...
						<div class="copyright-wrapper">
							<div class="copyright-left">&copy; 2014 Jay Huang & Daniel Engelhard</div>
						</div>
